...
const App: React.FC = () => {
  ...
  const renderError = (message: string) => (
    <div className="text-center bg-red-900/20 border border-red-500 p-8 rounded-lg">
      <h2 className="text-2xl font-bold text-red-400 mb-4">Creation Failed</h2>
      <p className="text-red-300">{message}</p>
      <button
        onClick={handleTryAgainFromError}
        className="mt-6 px-6 py-2 bg-emerald-600 rounded-lg hover:bg-emerald-700 transition-colors">
        Try Again
      </button>
    </div>
  );
  ...
  return (
    <div className="h-screen bg-black text-gray-200 flex flex-col font-sans overflow-hidden">
      ...
      <header className="py-6 flex flex-col justify-center items-center px-8 relative z-10 border-b border-gray-800 bg-gray-900/50 backdrop-blur-sm">
        <h1 className="text-4xl font-bold tracking-tight text-center bg-gradient-to-r from-emerald-400 via-yellow-200 to-emerald-400 bg-clip-text text-transparent">
          AdGenius AI
        </h1>
        <p className="text-gray-400 text-sm mt-1 tracking-wider uppercase">
          UGC • TikTok Shop • Supplements • 4K Ads
        </p>
      </header>
            ...
            <div className="flex-grow flex items-center justify-center">
              <div className="relative text-center">
                <h2 className="text-3xl font-light text-gray-400">
                  Select a <span className="text-emerald-400">Winning Template</span> below
                </h2>
